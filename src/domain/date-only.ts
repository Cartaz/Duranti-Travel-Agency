export function normalizeDateOnly(value: string, label = 'La data'): string {
...
export function normalizeOptionalDateOnly(value: string | undefined, label = 'La data'): string | undefined {
