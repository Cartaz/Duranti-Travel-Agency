...
- `expenses/` — exact minor-unit expense records linked atomically to planner blocks, payer assignment restricted to trip participants, and derived trip summaries separated by currency with category/payer breakdowns.
...
- `expenses/` — per-day totals, budgets and optional explicit FX workflows.
